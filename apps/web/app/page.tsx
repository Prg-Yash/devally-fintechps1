  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-4">
        <a href="#app" className="text-sm font-medium hover:opacity-70 transition-opacity">Launch App</a>
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex flex-col gap-8 text-2xl font-medium items-center font-jakarta tracking-[-0.04em]">
              ...
              <a href="#app" onClick={() => setIsOpen(false)}>Launch App</a>
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    return () => { lenis.destroy(); document.documentElement.style.cursor = 'auto'; };
  }, []);

  return (
    <main className="min-h-screen bg-[#FDFCF8] text-[#1A2406] selection:bg-[#D9F24F] selection:text-[#1A2406] overflow-x-hidden font-sans">
      <CustomCursor />
      <Navbar />
